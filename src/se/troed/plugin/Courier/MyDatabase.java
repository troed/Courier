...
// The whole MyDatabase class was written by Lennard Fonteijn - included here due to his Maven repository being outdated
//
// [---]
// I also almost forgot to mention the following: There is no license on this, at all!
// Do note though that I would highly appreciate it if you share changes you've made to the code with me.
// The best way to do this is forking the project over at GitHub and doing a pull request.
//
// If you feel obliged to credit me, please use my full name (Lennard Fonteijn)
// and have a link to my website (http://www.lennardf1989.com).
// Either way, I would appreciate it if you leave a note (reply, PM, whatever)
// whether or not you are using this in your plugins.
// [---]
//
